...
async def main():
    client = MultiServerMCPClient({
        "hybrid_search": {   # server name
            "command": "python",
            "args": [
                r"G:\Krish_Naik_LLMOps_Course\Projects\ecomm-assist\prod_assistant\mcp_servers\product_search_server.py"
            ],  # absolute path
            "transport": "stdio",
        }
    })
    ...
    # query = "iPhone 15"
    query = "What is the price of Apple iPhone 13 Pro Max?"
